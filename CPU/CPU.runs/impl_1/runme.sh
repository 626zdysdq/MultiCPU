...
HD_PWD=C:/Users/zhuduoyu/CPU/CPU.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log cpu_top_control.vdi -applog -m64 -messageDb vivado.pb -mode batch -source cpu_top_control.tcl -notrace
