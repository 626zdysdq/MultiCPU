...
HD_PWD=C:/Users/zhuduoyu/CPU/CPU.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log cpu_top_control.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cpu_top_control.tcl
